...
print(f'Вероятность выхода из строя 2 деталей {round(( (p1 * p2 * q3) + (p1 * p3 * q2) + (p2 * p3 * q1)) * 100, 3)} %')

# в). хотя бы одна деталь
#  Имеет место обратная ситуация тому, что                       все работают
print(f'Вероятность выхода из строя хотя бы 1 детали {round((1 - q1 * q2 * q3) * 100, 3)} %')

# г). от одной до двух деталей
#  Имеет место обратная ситуация тому, что                              все сломаны   или все работают
print(f'Вероятность выхода из строя от одной до двух деталей {round((1 - (p1 * p2 * p3) - (q1 * q2 * q3)) * 100, 3)} %')