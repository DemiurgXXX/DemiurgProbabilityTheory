...
print(f'Вероятность вытащить из первого ящика оба белых мяча: {round(probability_white2_box1 * 100, 3)} %')
# 0 белых из второго ящика
combination_white0_box2 = combination(9, 0)                                  # вариантов вытянуть 2 белых мяча из 9 возможных
...
probability_white1_box1 = combination_white1_box1 / combination_all_box1
print(f'Вероятность вытащить из первого ящика 1 белый мяч: {round(probability_white1_box1 * 100, 3)} %')
probability_white1_box2 = combination_white1_box2 / combination_all_box2
print(f'Вероятность вытащить из второго ящика 1 белый мяч: {round(probability_white1_box2 * 100, 3)} %')
# или
# из первого ящика взяли 0 белых мячей и из второго 2
combination_white0_box1 = combination(7, 0)                                  # вариантов вытянуть 2 белых мяча из 7 возможных
